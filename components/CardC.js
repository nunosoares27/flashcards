...
export class CardC extends Component {
  ...
  render() {
    ...
    if (questionNumber === decks[deck].questions.length) {
      ...
      const AnswerPercentage = Math.floor(
        this.state.correct * QuestionPercentage
      );
          ...
          <Content>
            <Animated.View style={[animatedStyle]}>
              <Card>
                ...
                >
                  <Animated.Text style={[rotateTextStyle]}>
                    {decks[deck].title}
                  </Animated.Text>
                </CardItem>
                <CardItem>
...
export default (CardCwithRouter = withRouter(
  connect(mapStateToProps, mapDispatchToProps)(CardC)
));
